Feature: Make a coffee with a complete coffee machine
  ...
  Scenario: A user plugs the coffee machine and try to make a coffee but the machine is out of order
    ...
    And I add 0.5 liter of "ROBUSTA" in the bean tank
    And I made a coffee "ROBUSTA"
    Then nothing is returned to the user because the machine is out of order
